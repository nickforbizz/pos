                ...
                <div class="card-body">
                    ...
                    <form id="products-create" action="@if(isset($product->id))  
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" type="text" class="form-control form-control" name="title" placeholder="Enter title ..." value="{{ old('title', $product->title ?? '')  }}" />
                        ...
                        <div class="form-group">
                            ...
                            <select name="make" id="make" class="form-control form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input id="slug" type="text" class="form-control form-control" disabled value="{{ old('slug', $product->slug ?? '') }}" />
